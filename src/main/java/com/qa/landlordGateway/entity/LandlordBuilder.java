...
public class LandlordBuilder {
	...
	public Landlord landlordBuild() {
		Landlord landlord = new Landlord(Optional.ofNullable(this.firstName).orElse("N/A"),
				Optional.ofNullable(this.lastName).orElse("N/A"), Optional.ofNullable(this.email).orElse("N/A"),
